...
$$F(t) = \mathbf{P}(T≤t) = \int_0^{t}f(x)dx$$
...
Regarding the mean time-to-event, similar as for the event probability, on average there was basically no error in the E or RE up to 30% censoring. For 60% censoring, unrealistic results were obtained for sample size 50. Other than that, for 60% censoring, the average RE ranged from 0.00 (-0.13; 0.16) for time-to-progression and size 500, to 0.23 (-0.27; 1.09) for time-to-progression and size 100. Excluding the scenario of 60% censoring and size 50, the average ARE ranged from 0.03 (0.00; 0.08) for multiple scenarios, to 0.34 (0.01; 1.09) for time-to-progression under 60% censoring and for size 100.

In terms of the $KLD$, similar trends were observed. The $KLD$ ranged from 0.03 (0.01; 0.05) for multiple scenarios, to 0.49 (0.03; 2.97) for time-to-death under 60% censoring and for size 50.
